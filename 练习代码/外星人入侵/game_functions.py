...
#
#     available_space_y = (ai_settings.ship_height - (3*alien_height) - ship_height)
...
#     alien.x = alien_width + 2 * alien.rect.height * row_number
...
#     number_rows = get_number_rows(ai_settings, ship.rect.height, ship.rect.height, alien.rect.height)
#
#     #创建外星人群
...
#         start_play_game(ai_settings, screen, sb, ship, aliens, bullets)
